...
public class BlinkinSubsystem extends SubsystemBase{
  ...
  public void defaultLighting() {
    double pwmSetting = m_defaultSettingEntry.getDouble(m_defaultSetting);
  ...
  public void signalCubes() {
    double pwmSetting = m_conesSettingEntry.getDouble(m_signalCubes);
    m_blinkinPort.set(pwmSetting);
    m_blinkinStar.set(pwmSetting);
  ...
  public void signalCones() {
    double pwmSetting = m_cubesSettingEntry.getDouble(m_signalCones);
    m_blinkinPort.set(pwmSetting);
    m_blinkinStar.set(pwmSetting);
